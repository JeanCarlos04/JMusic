...
export function Aside() {
  ...
  return (
    <>
      {getViewportSize > 500 ? (
        <aside className="w-[230px] gap-[30px] fixed h-full bg-[#282828] flex flex-col pt-[115px] z-[10]">
            ...
            <ul className="flex flex-col gap-[20px]">
              {playlist !== undefined && playlist.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <img
                          className="size-[25px]"
                          alt="Playlist icon"
                          src="/icons/eachPlaylistWhite.svg"
                        />
                ...
                <li className="flex flex-col items-center w-full gap-[20px]">
                  ...
                  <h3 className="text-[#999999]">No playlist created</h3>
                </li>
              )}
            </ul>
            <div className="flex flex-col gap-4 pl-8">
          ...
          <div className="w-full">
            <h2 className=" text-[#999999] text-center ">Recent Likes</h2>
          </div>
          <ul className="flex flex-col gap-[20px]">
        ...
        <aside className="flex w-screen h-10 fixed top-[90px] bg-[#313131] items-center justify-center gap-24">
          <Link to={"/"}>
            <img
              ...
              src="/icons/LupaGreen.svg"
            />
          </Link>
          <Link to={"/likedMusics"}>
            <img
              className="size-[23px] cursor-pointer"
              src="/icons/heartAddGreen.svg"
            />
          </Link>
          <Link to={"/playlist"}>
            <img
              className="size-[28px] cursor-pointer"
              src="/icons/PlaylistAdded.svg"
            />
          </Link>
        </aside>
      )}
